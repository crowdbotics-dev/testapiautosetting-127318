...
## Project Structure
    ...
    ├── testapiautosetting_127318  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127318`
...
2. Clone this repo and `cd testapiautosetting_127318`
